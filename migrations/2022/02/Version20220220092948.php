...
final class Version20220220092948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meal_template_meal (meal_id VARCHAR(255) NOT NULL, meal_template_id VARCHAR(255) NOT NULL, INDEX IDX_51011E7D639666D6 (meal_id), INDEX IDX_51011E7D8200930 (meal_template_id), PRIMARY KEY(meal_id, meal_template_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE meal_template_meal ADD CONSTRAINT FK_51011E7D639666D6 FOREIGN KEY (meal_id) REFERENCES meal_template (id)');
        $this->addSql('ALTER TABLE meal_template_meal ADD CONSTRAINT FK_51011E7D8200930 FOREIGN KEY (meal_template_id) REFERENCES meal (id)');
    }
